...
const Welcome = ({}) => (
    <AppLayout>
        <div style={{marginBottom: 60}}>
            ...
            <p>Collect and manage form data with serverless tech. <a href="https://github.com/serverless/forms-service">View
                source code on github</a></p>
            <h2>About the Frontend</h2>
            <ul>
                <li>
                    React application based on <a href="https://github.com/facebookincubator/create-react-app">create
                    react app</a>
                </li>
                <li>
                    Routing via <a href="https://reacttraining.com/react-router/web/guides/philosophy" rel="nofollow">react
                    router 4</a>
                </li>
                <li>
            ...
            <ul>
                ...
                <li>Made possible with the <a href="https://github.com/serverless/serverless">serverless framework</a>
                </li>
            </ul>

            <div>
                <img
                    src="https://user-images.githubusercontent.com/532272/34530669-bc0efe0c-f064-11e7-94fe-5a17b636d5f7.png"
                    alt="slsforms" style={{maxWidth: '800px'}}
                />
            </div>

            <h2>
                <a href="https://github.com/serverless/forms-service">Fork on github</a> built with love by <a
